...
sudo cp ~/jasonlws-nexus/nexus.rc /opt/nexus/bin/nexus.rc

# echo "[TASK 13] Configure nexus"
sudo cp ~/jasonlws-nexus/nexus.service /etc/systemd/system/nexus.service
sudo cp ~/jasonlws-nexus/nexus.vmoptions /opt/nexus/bin/nexus.vmoptions
sudo cp ~/jasonlws-nexus/admin.password /opt/sonatype-work/nexus3/admin.password
